...
public class QuantityServiceImpl implements QuantityService {
	...
	public <U extends IMeasurable> Quantity<U> add(Quantity<U> q1, Quantity<U> q2) {
		...
		try {
			...
			repository.save(new QuantityMeasurementEntity((Quantity<IMeasurable>) q1, (Quantity<IMeasurable>) q2, "ADD",
	...
	public <U extends IMeasurable> Quantity<U> subtract(Quantity<U> q1, Quantity<U> q2) {
		...
		try {
			...
			repository.save(new QuantityMeasurementEntity((Quantity<IMeasurable>) q1, (Quantity<IMeasurable>) q2,
					"SUBTRACT", (Quantity<IMeasurable>) result));
	...
	public <U extends IMeasurable> Quantity<U> convert(Quantity<U> quantity, U targetUnit) {
		...
		try {
			...
			repository.save(new QuantityMeasurementEntity((Quantity<IMeasurable>) quantity,
					(Quantity<IMeasurable>) result, "CONVERT", result.toString()));
			...
			repository.save(new QuantityMeasurementEntity((Quantity<IMeasurable>) quantity,
					(Quantity<IMeasurable>) quantity, "CONVERT", e.getMessage(), true));
	...
	private <U extends IMeasurable> void logError(Quantity<U> q1, Quantity<U> q2, String operation, Exception e) {
		...
		repository.save(new QuantityMeasurementEntity((Quantity<IMeasurable>) q1, (Quantity<IMeasurable>) q2, operation,
				e.getMessage(), true));
	}
}